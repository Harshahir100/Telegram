...
# ============================================================
# SCRAPING FUNCTIONS - UPDATED FOR 1TAMILMV.FI
# ============================================================

def scrape_movies():
    """Scrape movies from 1TamilMV.fi"""
    movies = []
    details = {}
    ...
    try:
        ...
        # Find movie links - look for topic links
        ...
        for link in all_links:
            ...
            # Check if it's a movie topic
            if '/topic/' in href and text and len(text) > 5:
                # Skip navigation links
                if 'Page' not in text and 'View' not in text:
...
def get_sample_movies():
    ...
    movies = [
        "BIGG BOSS Tamil (2026) S010 EP02",
        "BIGG BOSS Telugu (2026) S010 EP02",
        "Immortal (2026) Tamil HQ PreDVD",
        "Bethlehem Kudumba Unit (2026)",
        "I'm Game (2026) Tamil HQ PreDVD",
        "DC (2026) Tamil UHD + ESub",
        "G.D.N. (2026) Tamil UHD + ESub",
        "Arulvaan (2026) Tamil UHD + ESub",
        "Casino Royale (2006) BluRay",
        "Moana (2026) English HD + ESub"
    ]
...
🧲 <b>Magnet Link:</b>
<code>magnet:?xt=urn:btih:1234567890abcdef&dn={movie.replace(' ', '+')}&tr=udp://tracker.opentrackr.org:1337/announce&tr=udp://tracker.coppersurfer.tk:6969/announce</code>

📥 <a href='https://www.1tamilmv.fi'>⬇️ Visit Website for Torrent</a>

⚠️ <b>Note:</b> Please visit the website for actual download links.
Website may be blocking requests from Vercel."""
        ]
